...
final class SpoilerSchutz {
    ...
    static JSONArray abgeschlosseneFolgen(Iterable<Favorite> alle, Favorite ziel) {
        ...
        if (serie.isEmpty()) return ohneZurueckgenommene(ziel.abgeschlosseneFolgen(), ziel.zurueckgenommeneFolgen());
     ...
     * als die Belege anderer lokaler Eintraege derselben Serie.
     */
